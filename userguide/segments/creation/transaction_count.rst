...
3. In **Segment Parts** set the conditions that must be met to assign the customer to *only* **Transaction count** segment. 

   During creation, you need to specify **Minimum** and **Maximum** number to define the range in which the number of transactions must be found.  
   
.. image:: /userguide/_images/transaction_count.png
   :alt:   Transaction Number Type
