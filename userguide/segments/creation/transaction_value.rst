...
3. In **Segment Parts** set the conditions that must be met to assign the customer to *only* **Transaction value** segment. 

   During creation, you need to specify **Minimum** and **Maximum** value to define the range in which the value of all transactions must be found. 

.. image:: /userguide/_images/transaction_value.png
   :alt:   Transaction Value Type
